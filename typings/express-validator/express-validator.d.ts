...
declare module Express {
    export interface Request {
        ...
        check(field:string, message?:string): ExpressValidator.Validator;
        checkFiles(field:string, message?:string): ExpressValidator.Validator;
        checkBody(field:string, message?:string): ExpressValidator.Validator;
        checkParams(field:string, message?:string): ExpressValidator.Validator;
        checkQuery(field:string, message?:string): ExpressValidator.Validator;
        checkHeader(field:string, message?:string): ExpressValidator.Validator;
        assert(field:string, message?:string): ExpressValidator.Validator;
        sanitize(field:string): ExpressValidator.Sanitizer;
